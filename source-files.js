...
sourcesIndex["rome_service"] = {"name":"","dirs":[{"name":"configuration","dirs":[{"name":"linter","files":["mod.rs","rules.rs"]}],"files":["formatter.rs","javascript.rs","mod.rs"]},{"name":"file_handlers","files":["javascript.rs","json.rs","mod.rs","unknown.rs"]},{"name":"workspace","files":["server.rs"]}],"files":["lib.rs","settings.rs","workspace.rs"]};
createSourceSidebar();
